        ...
        if (!media.matches) {
            ...
            scrollParallax = function () {
                for (let index = 0; index < prxScrollImages.length; index++) {
                    ...
                    // if (!prxScrollImage.closest('._not')) {
...
if (faqSelect) {
    const faqSelectTitle = faqSelect.querySelector('.faq__select-title');
...
window.addEventListener("load", function () {
    const linkMenu = document.querySelector('.menu__link._goto');
    if (linkMenu) {
	...
	if (inputs.length > 0) {
		for (let index = 0; index < inputs.length; index++) {
			...
			if (input.classList.contains('_date')) {
				...
				// let currentDayContent = +currentDay.innerHTML;
...
if (rangeSlider) {
	...
	rangeSlider.noUiSlider.on('update', function (values, handle, unencoded, tap, positions, noUiSlider) {
		...
		/* if (values[0] == 20) {
			console.log('20 made');
			handleUi.classList.add('_last')
			handleUi.style.transform = `translate(-2.1%, 0%)`
			// handleUi.style.color = `red`
		} else {
			if (handleUi.classList.contains('_last')) {
				handleUi.classList.remove('_last')
			}
		} */
	});
	/* rangeSlider.noUiSlider.on('slide', function (values, handle, unencoded, tap, positions, noUiSlider) {
		if (positions[0] == 0) {
			...
			calculator.classList.remove('_trs');
		}
	}); */
	document.addEventListener("click", function (e) {
		const target = e.target
	...
	if (calculator) {
		...
		for (let index = 0; index < values.length; index++) {
			...
			/* if (value.dataset.value == 6) {
				value.classList.add('_mob-hide')
			} */
			// value.removeAttribute('style')
		}
	}
	// const input0 = document.getElementById('range-start');
	// const input1 = document.getElementById('range-end');
	...
	const input = document.getElementById('range-one-value');
