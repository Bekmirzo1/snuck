...
if (rangeSlider) {
	...
	document.addEventListener("click", function (e) {
		...
		if (target.closest('.noUi-value')) {
			rangeSlider.noUiSlider.set(target.closest('.noUi-value').dataset.value);
		}
	});
...
function _goto(target_block, speed, offset = document.querySelector('.header__wrapper').offsetHeight) {
